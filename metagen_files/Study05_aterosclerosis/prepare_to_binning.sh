...
for R1 in $READS_DIR/*.clean.trim.rmhost.rmhost.1.fq.gz; do

    # Find mate R2
    R2="${R1/.clean.trim.rmhost.rmhost.1.fq.gz/.clean.trim.rmhost.rmhost.2.fq.gz}"

    # Name of sample (ex.: CRR224755)
    BASENAME=$(basename "$R1" .clean.trim.rmhost.rmhost.1.fq.gz)
