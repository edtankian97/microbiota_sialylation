...
hmm_dir=../HMM_models/all_oacetil_plus_poli.hmm
seq_dir=../proteins/
...
for hmm_file in "$hmm_dir"; do
	...
	mv "$output_file" ../HMMER_analysis/o_acetiltrans_plus_poli/
	mv "$coverage_file" ../HMMER_analysis/o_acetiltrans_plus_poli/
    done
done
