...
for hmm_file in ../Protein_database/mafft_align/hmm_models/*.hmm; do
 ...
 #Coverage calculation
	...
	mv "$output_file"  ../HMMER_analysis
 mv "$coverage_file" ./HMMER_analysis
